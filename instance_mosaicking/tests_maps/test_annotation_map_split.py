...
from instance_mosaicking.maps.annotation_map_split import Dataset
...
crs = from_epsg(epsg)
test_config = {'shapefile_path': "/root/instance_mosaicking/data/random_generation/ellipses_100_3_300_1000.shp", 
               'save_dir': "/root/instance_mosaicking/data/random_generation/split", 
               'crs':crs, 
               'area_x1':0, 
               'area_y1':0, 
...
test_config = {'shapefile_path': "/root/instance_mosaicking/data/random_generation/ellipses_100_3_300_1000.shp", 
               'save_dir': "/root/instance_mosaicking/data/random_generation/split_shp_tif", 
               'crs':crs, 
               'area_x1':0, 
               'area_y1':0, 
               'area_x2':30, # this should be modified for different shapefiles
               ...
               'tile_size':10, 
               'overlap':1,
               'tif_path': '/root/instance_mosaicking/data/random_generation/ellipses_100_3_300_1000.tif', 
               'keep_instance_tif': True}
...
ellipse_data = Dataset(pixel_size=1000, split_path='/root/instance_mosaicking/data/random_generation/split_shp_tif', input_channel=(0,))
